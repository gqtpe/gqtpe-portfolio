<template>
  <section>
    ...
    >
      <div
          ref="scrollerRef"
          :class="`${scrollerClassName} dark:text-white flex whitespace-nowrap text-center font-sans text-4xl font-bold tracking-[-0.02em] drop-shadow md:text-[5rem] md:leading-[5rem]`"
