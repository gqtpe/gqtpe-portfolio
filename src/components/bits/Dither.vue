...
float getBayerValue(int x, int y) {
  // Матрица Байера 8x8 (без изменений)
  if (y == 0) {
...
const resize = () => {
  ...
  // Дополнительная оптимизация: можно ограничить dpr, если все еще тормозит
...
const update = (t: number) => {
  ...
  program.uniforms.backgroundColor.value = props.backgroundColor;
...
const initializeScene = () => {
  ...
  // Оптимизация: dpr можно поставить меньше 1 для очень слабых устройств,
  // но default поведения обычно достаточно, если pixelSize большой.
